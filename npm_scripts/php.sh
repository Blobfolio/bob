...
./node_modules/blobfolio-phpcs/lib/vendor/bin/phpcs --colors --standard=Blobfolio --encoding=utf8 --report=full --ignore='node_modules/*' --extensions=php --parallel=4 ./
if [ $? -eq 0 ]; then
	...
	./node_modules/blobfolio-phpcs/lib/vendor/bin/phpcs --colors --standard=Blobfolio --encoding=utf8 --report=notifysend --ignore='node_modules/*' --extensions=php --parallel=4 ./
fi
